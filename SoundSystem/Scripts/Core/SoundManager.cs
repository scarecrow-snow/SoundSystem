...
namespace AudioSystem
{
    ...
    public class SoundManager : PersistentSingleton<SoundManager>
    {
        ...
        /// </summary>
        [SerializeField, Tooltip("SoundEmitterのプレハブ。プールで使用されるオブジェクトの元となります")]
        ...
        /// </summary>
        [SerializeField, Tooltip("プールのコレクションチェックを有効にするか（デバッグ用）")]
        ...
        /// </summary>
        [SerializeField, Tooltip("プールの初期容量（事前作成されるオブジェクト数）")]
        ...
        /// </summary>
        [SerializeField, Tooltip("プールの最大サイズ（保持できる最大オブジェクト数）")]
        int maxPoolSize = 100;
        ...
        /// </summary>
        [SerializeField, Tooltip("同一サウンドの最大同時再生数（パフォーマンス保護）")]
